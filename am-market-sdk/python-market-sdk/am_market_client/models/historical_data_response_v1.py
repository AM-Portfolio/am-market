...
class HistoricalDataResponseV1(BaseModel):
    """
    HistoricalDataResponseV1
    """ # noqa: E501
    data: Optional[Dict[str, HistoricalData]] = None
    metadata: Optional[HistoricalDataMetadata] = None
    error: Optional[StrictStr] = None
    message: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["data", "metadata", "error", "message"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": dict(
                (_k, HistoricalData.from_dict(_v))
                for _k, _v in obj["data"].items()
            )
            if obj.get("data") is not None
            else None,
            "metadata": HistoricalDataMetadata.from_dict(obj["metadata"]) if obj.get("metadata") is not None else None,
            "error": obj.get("error"),
