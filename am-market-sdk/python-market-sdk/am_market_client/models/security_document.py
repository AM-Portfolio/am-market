...
class SecurityDocument(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "key", "metadata", "audit"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "key": SecurityKey.from_dict(obj["key"]) if obj.get("key") is not None else None,
            "metadata": SecurityMetadata.from_dict(obj["metadata"]) if obj.get("metadata") is not None else None,
